...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-pink-50/50 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2
            className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-100 text-4xl md:text-5xl font-bold text-gray-900"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-300 grid grid-cols-2 gap-4 mt-8">
              {highlights.map((item, index) => (
                <div
                  key={item.label}
                  className="p-5 bg-gray-50 rounded-2xl hover:bg-pink-50 transition-all duration-300 group cursor-default"
                >
                  <item.icon className="w-8 h-8 text-pink-500 mb-3 group-hover:scale-110 transition-transform" />
          ...
          <div className="space-y-8">
            ...
            <div className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-300">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Frontend Skills</h3>
            ...
            <div className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-400">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Backend Skills</h3>
              <div className="space-y-4">
            ...
            <div className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-500">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.tools.map((tool) => (
                  <span
                    key={tool}
                    className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium hover:bg-pink-100 hover:text-pink-700 transition-colors cursor-default"
                  >
                    {tool}
                  </span>
                ))}
            ...
            <div className="reveal opacity-0 translate-y-8 transition-all duration-700 delay-600">
              ...
              <div className="flex flex-wrap gap-2">
                {softSkills.map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-purple-50 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-100 transition-colors cursor-default"
                  >
                    {skill}
                  </span>
                ))}
