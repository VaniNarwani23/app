          ...
          <div>
            ...
            <div className="space-y-6">
              {experience.map((exp, index) => (
                ...
                >
                  <div className="relative pl-8 pb-8 border-l-2 border-pink-200 last:pb-0">
                    {/* Timeline dot */}
                    <div className="absolute -left-[9px] top-0 w-4 h-4 bg-pink-500 rounded-full border-4 border-white shadow" />
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <p className="text-pink-600 font-medium mb-3">{exp.company}</p>
          ...
          <div>
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                ...
                >
                  <div className="relative pl-8 pb-8 border-l-2 border-purple-200 last:pb-0">
                    {/* Timeline dot */}
                    <div className="absolute -left-[9px] top-0 w-4 h-4 bg-purple-500 rounded-full border-4 border-white shadow" />
